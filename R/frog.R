...
#'     and approximated egg size from photographs.
#'     The data are used to estimate
#'     whether maternal investment changes at
#'     varying altitudes on the Tibetan Plateau.  Investment is assessed by measuring
#'     how reproducing females allocated their energy to egg productions of size or number,
#'     all characteristics of offspring fitness.  Source data on size and volume
#'     in log_10 scale have
#'     been converted to standard numeric scale.
#'
