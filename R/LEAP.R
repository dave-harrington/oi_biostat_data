#' Patient level data on the randomized trial Learning Early About Peanut (LEAP)
#' allergies
#'
#' @docType data
#' @description
...
#'      \item{\code{stratum}}{Factor, pre-randomization stratum of the participant,
#'      levels \code{SPT-Negative}, code{SPT-Positive}}
