#' A dataframe of 1397 rows and 10 variables used to examine the relationship between
#'     muscle strength and the single nucleotide polymorphism (SNP) actn3.r577x
#'@name famuss
#'@docType data
