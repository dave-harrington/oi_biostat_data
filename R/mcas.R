...
#'   \item{\code{english_learner}}{Numeric, percentage of students for whom English whose first
#'        language is other than English and who cannot perform ordinary classroom
#'        work in English.}
#'   \item{\code{students_disabilities}}{Numeric, percentage of students in the school who have an
...
#'     \item{\code{exp_per_pupil}}{Numeric, amount spent by the district per pupil, in dollars.
#'        Calculated by dividing a district's operating expenditures by its average pupil
#'        membership.}
#'     \item{\code{majority}}{Character, coded "white" if >= 50% of the students in the school are in racial
