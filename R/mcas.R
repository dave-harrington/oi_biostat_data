...
#'     whether school districts, schools, and students are meeting expectations. This dataset
#'	   records the percentage of students scoring proficient or advanced in the 2018 Mathematics
#'     test.  School-level variables include possible predictors of test performance such as the
...
#'        membership.}
#'     \item{\code{majority}}{Character, coded \code{white} if \eqn{\ge} 50% of the students in the school are in racial
#'          category white, otherwise coded \code{minority}}
#'     }
