...
#'
#' @description  Infant mortality data extracted from September 2023 posting of US Centers for Disease
#'     Control and Prevention.  Mortality data for 2022 is listed as provisional and is subject to change.
#'     Physician data extracted from table 16 of Health United States 2019, National Center for Health Statistics (US)
#'     and represents number of physicians in patient care per 100,000 resident population in 2018, by state.
#'
#'
