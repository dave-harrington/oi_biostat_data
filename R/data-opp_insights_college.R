...
#'     parental income distributions and student earnings outcomes by college. The data
#'     in this package do not include tiers 12 (less than two year schools of any type),
#'     13 (students attending college with insufficient data), and 14 (students not
#'     in college between the ages of 19-22).  Monetary values are measured in 2015 dollars;
#'     i.e. adjusted for inflation to 2015 dollars.
#'
...
#'
#' @description
#' A dataset based on the larger Opportunity Insights data (opp_insights_colleges) that is
#'     restricted to 4-year not-for-profit colleges.  Schools with 2-year programs or are
#'     for-profit schools have been dropped from the parent dataset.  See the parent
#'     dataset for source and variable documentation
#'
